...
export const Editor = () => {
  ...
  <h1>The Adventures of <mark>Carto</mark> and <mark>Toon</mark>: A Creative Journey</h1>
...
`;
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: cn(
          "focus:outline-none",
          "[&_h1]:text-4xl [&_h1]:font-bold [&_h1]:mb-6 [&_h1]:mt-8", // H1
          "[&_h2]:text-3xl [&_h2]:font-semibold [&_h2]:mb-5 [&_h2]:mt-7", // H2
          "[&_h3]:text-2xl [&_h3]:font-medium [&_h3]:mb-4 [&_h3]:mt-6", // H3
          "[&_h4]:text-xl [&_h4]:font-normal [&_h4]:mb-3 [&_h4]:mt-5", // H4
          "[&_h5]:text-lg [&_h5]:font-light [&_h5]:mb-2 [&_h5]:mt-4", // H5
          "[&_h6]:text-base [&_h6]:font-thin [&_h6]:mb-1 [&_h6]:mt-3", // H6
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <EditorContent
        className="w-[700px] bg-background/25 min-h-screen my-4 rounded-md"
        editor={editor}
      />
    </div>
  );
